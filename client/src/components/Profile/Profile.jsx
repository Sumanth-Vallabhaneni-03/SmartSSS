...
const Profile = () => {
  ...
  useEffect(() => {
    if (currentUser?.email) {
      ...
      axios.get(`http://smart-bridge-backend.vercel.app/getUser?email=${currentUser.email}`)
        .then((response) => {
  ...
  const handleSave = async () => {
    ...
    try {
      const response = await axios.put("http://smart-bridge-backend.vercel.app/updateProfile", {
